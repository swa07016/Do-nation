            ...
            <div className="single-job-items mb-30">
                <div className="job-items">
                    <div className="company-img">
                        <a onClick={toggle}><img src="assets/img/gallery/socialEvents1.png" alt=""/></a>
                    </div>
                    <div className="job-tittle">
                        <a onClick={toggle}><h4>경희대학교 병원</h4></a>
                        <ul>
                    ...
                    <Col sm="12">
                        <Container  style={{
                            ...
                            <Row>
                                ...
                                <hr/>
                                기부 물품
                                <Input type="select" name="select" id="exampleSelect" value={pick}
